...
def tour(id):
    departure_name = dep_name(tours.get(id)['departure'])

    return render_template("tour.html", departure_name=departure_name, title=title, subtitle=subtitle, description=description, departures=departures, tours=tours.get(id))
